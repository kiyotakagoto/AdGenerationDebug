...
@property (nonatomic, strong, readonly, getter=getAdOption) NSDictionary *adOption;
...
- (void)disableCheckingWebViewFillerAd;
...
- (void)ADGManagerViewControllerOpenUrl:(ADGManagerViewController *)adgManagerViewController __attribute__((deprecated));
- (void)ADGManagerViewControllerFailedToReceiveAd:(ADGManagerViewController *)adgManagerViewController
